...
<head>
    ...
    <script src="../scripts/cargar-consultas.js" defer></script> 
</head>
<body>
        ...
        <div class="modal-dialog">
          <div class="modal-content">
            <div class="modal-header">
              <h5 class="modal-title" id="modalLabel">Respuesta enviada</h5>
            </div>
            <div class="modal-body">
              La respuesta fue enviada de forma exitosa.
            </div>
    ...
    <table id="consultas" class="w-75 mx-auto mt-3"></table>
</body>
</html>