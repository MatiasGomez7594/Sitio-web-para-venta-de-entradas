<nav class="navbar navbar-expand-lg navbar-dark bg-dark  w-100 " style="z-index: 1;">
        <div class="container-fluid">
          ...
          <a class="navbar-brand" href="crear-evento.php">Crear evento</a>
          ...
          <div class="collapse navbar-collapse" id="navbarSupportedContent">
            <ul class="navbar-nav me-auto mb-2 mb-lg-0">
              <li class="nav-item dropdown">
                <a class="nav-link active dropdown-toggle " href="interfaz-admin-eventos.php" role="button" data-bs-toggle="dropdown" aria-expanded="false">
                  Mi cuenta
                </a>
