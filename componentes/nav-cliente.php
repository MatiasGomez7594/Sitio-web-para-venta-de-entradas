          ...
          <div class="collapse navbar-collapse" id="navbarSupportedContent">
            <ul class="navbar-nav me-auto mb-2 mb-lg-0">
              <li class="nav-item dropdown">
                <a class="nav-link active dropdown-toggle " href="mi-cuenta.php" role="button" data-bs-toggle="dropdown" aria-expanded="false">
                  Mi perfil
                </a>
                <ul class="dropdown-menu bg-dark">
                  ...
                  <li><a class="dropdown-item bg-dark text-light" href="eliminar-perfil.php">Eliminar perfil</a></li>
